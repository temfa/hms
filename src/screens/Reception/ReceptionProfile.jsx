...
import PreviewRecord from "../../components/Preview/previewRecord";
...
const ReceptionProfile = () => {
  ...
  const { singleUsers, getSingleUserLoading } = useGetSingleUsers(locate[locate.length - 1], "/recordofficers");
  const [activeTab, setActiveTab] = useState(1);
  const tabPanel = () => {
    switch (activeTab) {
      case 1:
        return <PreviewRecord data={singleUsers} />;
      // case 2:
      //   return <PatientsUsed />;
      case 3:
      ...
      {getSingleUserLoading ? (
        ...
        <>
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-semibold"> {singleUsers?.fullname}</h1>
          </div>
          <div className=" grid grid-cols-12 gap-6 my-8 items-start">
            <div
              ...
              <div className="gap-2 flex-colo">
                <h2 className="text-sm font-semibold"> {singleUsers?.fullname}</h2>
