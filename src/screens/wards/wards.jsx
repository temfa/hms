...
const Wards = () => {
  const { getAllWardLoading, allWards } = useGetAllWards();
  ...
  return (
    <Layout>
      {isOpen && <AddClinicsModal closeModal={onCloseModal} isOpen={isOpen} title="Ward" datas={null} />}
      {/* add button */}
      {/* add button */}
      <button
      ...
      {/*  */}
      <h1 className="text-xl font-semibold">Wards</h1>
